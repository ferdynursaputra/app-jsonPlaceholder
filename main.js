            ...
            <tr>
                ...
                <td>
                    <div class="d-flex gap-2">
                        ...
                        <button class="btn btn-danger btn-sm" onclick="showUserPosts(${user.id})">View Posts</button>
                        <button class="btn btn-success btn-sm" onclick="showUserComments(${user.id})">View Comments</button>
                    </div>
                </td>
            </tr>
        `;
